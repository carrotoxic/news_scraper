...
if response.status_code == 200:
    ...
    for articles in soup.find_all('ul', class_='posts-list'):
        ...
        for elem in article:
            ...
            if response_url.status_code == 200:
                ...
                for lines in soup2.find_all('div', attrs={ 'class': ['tombstone-enable'] }):
                    all_text  +=  lines.text
...
print(df)
df.to_excel('a16z_content.xlsx', index=False)
